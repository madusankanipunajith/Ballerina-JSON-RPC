...
const DISCONNECT_ERROR = "Something went wrong while client is disconnecting from the server. Make sure wether the client has been registered";
...
const EMPTY_MESSAGE = "Requested message is empty";